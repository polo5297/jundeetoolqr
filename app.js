...
function render() {
  ...
  renderWorkers(); renderAssets(); renderHistory(); updateLookup();
}
...
function renderAssets() {
  ...
  const assets = state.assets.filter(a => `${a.assetNumber} ${a.name} ${a.category} ${a.location} ${a.holder} ${a.serialNumber} ${a.partNumber}`.toLowerCase().includes(q));
